# Vitable Connect TypeScript Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2FVitable-Inc%2Fvitable-connect-typescript)
[![npm shield](https://img.shields.io/npm/v/@vitable-inc/vitable-connect)](https://www.npmjs.com/package/@vitable-inc/vitable-connect)

The Vitable Connect TypeScript library provides convenient access to the Vitable Connect APIs from TypeScript.
...
```sh
npm i -s @vitable-inc/vitable-connect
```

## Reference

A full reference for this library is available [here](https://github.com/Vitable-Inc/vitable-connect-typescript/blob/HEAD/./reference.md).
...
const client = new VitableConnectClient({ apiKey: "YOUR_API_KEY" });
...
```ts
import VitableConnect from 'npm:@vitable-inc/vitable-connect';
...
We are keen for your feedback; please open an [issue](https://www.github.com/Vitable-Inc/vitable-connect-typescript/issues) with questions, bugs, or suggestions.
...
```typescript
import { VitableConnectClient, VitableConnectEnvironment } from "@vitable-inc/vitable-connect";
...
const request: VitableConnect.IssueAccessTokenRequest = {
    ...
};
```
...
```typescript
import { AuthClient } from '@vitable-inc/vitable-connect/auth';
...
```typescript
const { data, rawResponse } = await client.auth.issueAccessToken(...).withRawResponse();
...
```typescript
import { VitableConnectClient, logging } from "@vitable-inc/vitable-connect";
