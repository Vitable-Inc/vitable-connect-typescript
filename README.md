...
[![NPM version](<https://img.shields.io/npm/v/@vitable-inc/vitable-connect.svg?label=npm%20(stable)>)](https://npmjs.org/package/@vitable-inc/vitable-connect) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@vitable-inc/vitable-connect)
...
```sh
npm install @vitable-inc/vitable-connect
```
