...
export type AuthOption =
    ...
    | core.AuthProvider
    | AnyAuthProvider.AuthOptions<[BearerAuthProvider.AuthOptions]>;

export type BaseClientOptions = {
    environment?: core.Supplier<environments.VitableConnectEnvironment | string>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "User-Agent": "@vitable-inc/vitable-connect/2.0.0",
...
export function normalizeClientOptionsWithAuth<T extends BaseClientOptions = BaseClientOptions>(
    ...
    normalized.authProvider ??= AnyAuthProvider.createInstance(normalizedWithNoOpAuthProvider, [BearerAuthProvider]);
    return normalized;
}
