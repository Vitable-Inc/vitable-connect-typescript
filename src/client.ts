...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['VITABLE_PARTNER_API_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['VITABLE_PARTNER_API_LOG'] or 'warn' if it isn't set.
   */
 ...
 */
export class VitablePartnerAPI {
  apiKey: string;
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? VitablePartnerAPI.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('VITABLE_PARTNER_API_LOG'), "process.env['VITABLE_PARTNER_API_LOG']", this) ??
      defaultLogLevel;
  ...
  static VitablePartnerAPI = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static VitablePartnerAPIError = Errors.VitablePartnerAPIError;
